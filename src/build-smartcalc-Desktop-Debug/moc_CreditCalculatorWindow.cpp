...
#include <memory>
#include "../smartcalc/creditcalculatorwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CreditCalculatorWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CreditCalculatorWindow_t qt_meta_stringdata_CreditCalculatorWindow = {
    {
QT_MOC_LITERAL(0, 0, 22) // "CreditCalculatorWindow"
...
QT_INIT_METAOBJECT const QMetaObject CreditCalculatorWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_CreditCalculatorWindow.data,
